...
(function ($) {
  ...
  $container.append(
    '<h5>Impostazioni Pagina</h5><hr class="mb-2"/>'
  )
  ...
  $container.append('<h6>Opzioni Header</h6>')
  ...
  $container.append('<h6>Opzioni Sidebar</h6>')
  ...
  $container.append('<h6>Opzioni Footer</h6>')
  ...
  $container.append('<h6>Opzioni Testo piccolo</h6>')
  ...
  $container.append('<h6>Varianti Navbar</h6>')
